            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-xs text-gray-400">
                            ...
                            <li><Link href="#" className="hover:text-white">Resources name</Link></li>
                            <li><Link href="#" className="hover:text-white">Another</Link></li>
                        </ul>
                    </div>

                    {/* About Link */}
                    <div>
                        <h4 className="font-bold text-sm mb-4">About Link</h4>
                        <ul className="space-y-2 text-xs text-gray-400">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-xs text-gray-400">
                            ...
                            <li><Link href="#" className="hover:text-white">Products Two</Link></li>
                            <li><Link href="#" className="hover:text-white">Products three</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mb-3">
                            Sign up to receive updates, access<br />to exclusive deal and more.
                        </p>
                        <div className="flex gap-2">
                            <input
                                type="email"
                                placeholder="Enter email"
                                className="bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-xs text-white placeholder:text-gray-500 focus:outline-none focus:border-brand-green flex-1"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-gray-500">
                        © 2024 Rheemaa Furniture. All rights reserved.
                    </p>
